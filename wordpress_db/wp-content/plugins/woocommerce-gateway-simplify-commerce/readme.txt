...
**Before downloading:** 
The payment extension on this page (Version 1.0.4) is not the latest version of the extension. To download and install the most up-to-date extension that is supported by Simplify Commerce, please follow the instructions [here:](https://github.com/simplifycom/woocommerce-simplify-payment-gateway-plugin/blob/master/README.md)
