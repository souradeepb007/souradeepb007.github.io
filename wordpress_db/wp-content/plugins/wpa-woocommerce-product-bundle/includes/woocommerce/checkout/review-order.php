...
<table class="shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th class="product-thumb"><?php esc_html_e( 'Product', 'claue' ); ?></th>
			<th class="product-name"></th>
			<th class="product-total"><?php esc_html_e( 'Total', 'claue' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
						...
						<td class="item-name">
							...
							<?php
								if ( class_exists( 'WPA_WCPB' ) ) {
									...
									$custom_variable 	= ( isset( $cart_item['bundle-variable'] ) ) ? $cart_item['bundle-variable'] : array();
									if ( $bundles ) {
										echo '<ul class="product-bundle mt__10">';
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Subtotal', 'claue' ); ?></th>
		...
		<tr class="order-total">
			<th><?php esc_html_e( 'Total', 'claue' ); ?></th>
