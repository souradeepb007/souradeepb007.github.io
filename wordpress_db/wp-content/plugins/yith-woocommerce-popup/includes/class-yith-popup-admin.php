...
if( ! class_exists( 'YITH_Popup_Admin' ) ) {
    ...
    class YITH_Popup_Admin {
	    ...
	    public function plugin_row_meta( $new_row_meta_args, $plugin_meta, $plugin_file, $plugin_data, $status, $init_file = 'YITH_YPOP_FREE_INIT' ) {
        ...
        public function register_panel() {
            ...
            $args = array(
                ...
                'parent_slug'      => '',
                'page_title'       =>  _x( 'WC Popup', 'Plugin name. Do not translate.','yith-woocommerce-popup' ),
                'menu_title'       =>  _x( 'WC Popup', 'Plugin name. Do not translate.','yith-woocommerce-popup' ),
